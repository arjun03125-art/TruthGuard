      ...
      <div className="container-narrow relative z-10">
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  >
                    {verdictStyles.icon && (
                      <verdictStyles.icon
                        className={`h-8 w-8 ${verdictStyles.color}`}
                      />
                    )}
                  </motion.div>
                  ...
                  <div>
                    <div
                      className={`text-2xl font-display font-bold ${verdictStyles.color}`}
                    >
                      {verdictStyles.label}
                    </div>
        ...
        <ScrollReveal delay={0.25}>
          <p className="text-center text-xs text-muted-foreground mt-6">
            Powered by AI. Results are for informational purposes only and should
